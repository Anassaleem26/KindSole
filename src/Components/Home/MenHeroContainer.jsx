...
import MenSectionBg from '../../../src/assets/men section bg-img/aiease_1776948496835.jpg';
import Card from '../ui/Card';
import configservice from '../../Firebase/Config-services';
import { Link } from 'react-router-dom';


function MenHeroContainer() {
        ...
        <div>
            ...
            <div className="relative h-100 pb-6 w-full flex items-end justify-center">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url("${MenSectionBg}")`,
            ...
            <div className="flex w-full h-120 overflow-hidden pb-4">
                ...
                <div className="w-1/2 h-full overflow-hidden cursor-pointer">
                    <img
                        ...
                        src="/src/assets/men section bg-img/webdonut-hipster-958805.jpg"
                        alt="Men 1"
                    />
                </div>
                ...
                <div className="w-1/2 h-full overflow-hidden cursor-pointer ">
                    <img
                        className="w-full h-full object-cover transition-transform duration-[1500ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:scale-110"
                        src="/src/assets/men section bg-img/Gemini_Generated_Image_xvlnb0xvlnb0xvln.png"
                        alt="Men 2"
                    />
                </div>
            ...
            <div className='py-8 px-13'>
                <h2 className=' text-3xl font-bold text-black mb-7 uppercase'>Men Shoes</h2>
...
export default MenHeroContainer